...
# json returns in this structure:
# {'return_key':
#   ['return_values'
#       {'return_result_key':'return_result_value'}, {'return_result_key':'return_result_value'} ]}
# dictionary[dict key][list index][dict key] returns a value belonging to that list index
print(json_data['drinks'][0]['strDrink'])
